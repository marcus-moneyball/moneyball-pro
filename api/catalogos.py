...
CAMPOS_ROTEIRO_POR_ESPORTE = {
    ...
    "nfl": [
        # Eficiência por Jogada (EPA e Success Rate)
        "team_a_success_rate_of", "team_b_success_rate_of",
        "team_a_success_rate_def", "team_b_success_rate_def",
        "team_a_epa_play_of", "team_b_epa_play_of",
        "team_a_epa_play_def", "team_b_epa_play_def",
        # Situcional Avançado
        "team_a_explosive_play_rate", "team_b_explosive_play_rate",
        "team_a_red_zone_efficiency", "team_b_red_zone_efficiency",
