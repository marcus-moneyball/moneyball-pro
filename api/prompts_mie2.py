...
- "msc_calculado" -> este é o valor EXATO que vai no campo de saída "msc_score".
  Nunca invente um msc_score diferente do que veio calculado. Esse é o valor
  BASE (só a força matemática do candidato) -- o ajuste final por convergência
  acontece depois, em Python, então você não precisa (e não deve) tentar
  incorporar convergência nesse número, só devolver exatamente o que veio.
